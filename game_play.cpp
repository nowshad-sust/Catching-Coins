...
void game_play(int speed)
{
    ...
    int x = 400,y=500, bucket_size=70,element_size=50;
    ...
    while(life_remain>0)
    {
        ...
        readimagefile("img/rename.jpg", x, y, x+bucket_size, y+bucket_size);
            ...
            if(i>600)
            {
                ...
                //
                if(count<20)
                    coin_random = random2[count]%3+1;
                else if(count>=20&&count<40)
                    coin_random = random2[count]%4+1;
                else if(count>=40&&count<60)
                    coin_random = random2[count]%5+1;
                else if(count>=60&&count<80)
                    coin_random = random2[count]%6+1;
                else if(count>=80)
                    coin_random = random2[count]%7+1;
